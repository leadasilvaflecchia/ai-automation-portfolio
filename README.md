...
Flujos de automatización e IA con n8n, LLMs y APIs. Incluye distribución de leads, triaje de soporte al cliente e integraciones de CRM.
...
* **Modelos de IA:** OpenAI API / Claude
* **Integraciones:** Google Workspace (Sheets, Drive, Gmail)
